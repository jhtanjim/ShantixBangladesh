  ...
  return (
    <div>
      ...
      <div className="container mx-auto px-4 my-8">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-800 mb-2">Find Your Perfect Car</h2>
          <p className="text-gray-600">Search through our extensive collection of quality vehicles</p>
        </div>

        <SearchFilter carsResponse={carsResponse || []} onFilteredResults={handleFilteredResults} />
      </div>
      ...
      {/* No Results State */}
      {!isLoading && carsResponse && carsResponse.length === 0 && (
        <div className="container mx-auto px-4 my-12">
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-12">
          ...
          <div className="w-full lg:w-[60%] text-center lg:text-left">
            ...
            <p className="text-lg md:text-2xl mt-4">
              Lorem ipsum dolor sit amet consectetur. Lectus nibh morbi non proin dui ut. Vel vestibulum dolor sagittis
              pulvinar felis ac. Ullamcorper non dictum in ullamcorper eros vel viverra. Venenatis magna lacus malesuada
              proin quam parturient viverra tellus.
            </p>
