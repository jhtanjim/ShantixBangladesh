...
import { Plus, Ship, RefreshCw, AlertCircle, Calendar, Loader } from 'lucide-react';
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-6">
            {error.message || 'Something went wrong while loading the adminSchedules.'}
          </p>
          <button
            onClick={() => refetch()}
      ...
      >
        ...
        {!isLoading && filteredSchedules.length === 0 && (
          <div className="bg-white rounded-2xl shadow-xl p-12 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-2">
              {searchTerm || statusFilter !== 'all' ? 'No adminSchedules found' : 'No adminSchedules yet'}
            </h3>
