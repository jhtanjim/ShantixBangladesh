...
export function Dashboard() {
  ...
  const stats = useMemo(() => {
    ...
    const activeCars = cars.filter(
      (car) => car?.isActive && car?.status === "AVAILABLE"
    ).length;
  ...
  const recentCars = useMemo(() => {
    ...
    return cars
      ...
      .map((car) => ({
        ...
        status:
          car.isActive && car.status === "AVAILABLE" ? "Active" : "Inactive",
        ...
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center">
            ...
            <div className="mt-4 text-sm text-gray-600">
              {carsError && (
                <p>Cars Error: {carsError.message || "Unknown error"}</p>
              )}
              {usersError && (
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-600 text-sm mt-1">
                  Latest cars added to the system
                </p>
              </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-sm font-semibold text-blue-600">
                {cars.filter((car) => car?.isActive).length}
              </span>
            </div>
          </div>
        </div>
