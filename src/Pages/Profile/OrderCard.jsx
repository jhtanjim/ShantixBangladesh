...
import { Package, Calendar, CreditCard, MapPin, FileText, Upload, X, CheckCircle, AlertCircle, Eye } from 'lucide-react'
...
const OrderCard = ({ order, handleFileUpload, uploadPaymentMutation }) => {
  ...
  const validateFile = (file) => {
    ...
    if (file.size > maxSize) {
      Swal.fire({
        ...
        text: `File size is ${formatFileSize(file.size)}. Please select a file smaller than ${formatFileSize(maxSize)}.`,
        confirmButtonColor: '#3085d6'
      })
      return false
    }
  ...
  const handlePaymentUpload = async () => {
    ...
    try {
      ...
      if (error.message.includes('network') || error.message.includes('fetch')) {
        ...
        errorMessage = 'File size is too large. Please compress your image and try again.'
  ...
  const showPaymentUpload = ['PENDING_PAYMENT', 'NEGOTIATING'].includes(order.status)
    ...
    <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-lg border-0 hover:shadow-xl transition-shadow p-6">
      <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-6">
            ...
            <div className="p-3 bg-green-50 border border-green-200 rounded-lg">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-sm font-semibold text-green-800">Payment screenshot uploaded</p>
                </div>
        ...
        <div className="flex flex-col items-end gap-3 min-w-[250px]">
          ...
          <a
            href={`https://wa.me/8801752742031?text=${encodeURIComponent(`Hello, I have a question about Order ID: ${order.id}`)}`}
            target="_blank"
            ...
            <div className="flex flex-col gap-2 w-full">
              <div className="p-4 bg-amber-50 border border-amber-200 rounded-lg">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <p className="text-sm font-semibold text-amber-800">Upload Payment Screenshot</p>
                </div>
                ...
                {!selectedFile ? (
                  ...
                  >
                    ...
                    <p className="text-sm text-amber-700 mb-1">Click to select or drag & drop</p>
