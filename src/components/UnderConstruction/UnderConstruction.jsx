      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mb-8">
            Our team is working hard to bring you the ultimate car buying
            experience.
          </p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <div className="text-left">
                ...
                <p className="text-gray-600 text-sm">+8801771123456</p>
        ...
        <div className="mt-8">
          <p className="text-gray-500 text-sm">
            © 2025 Shantix Corporation. Building the future of automotive
            excellence.
          </p>
        </div>
      </div>
